...
namespace SnooperSocket.Cryptography.Protocals
{
    public class MutualKeyProtocal : SnooperSecurityProtocal
    {
        ...
        public override void EncryptStream(MemoryStream Input, out MemoryStream Output, ref Dictionary<string, string> Headers)
        {
        ...
        public override void DecryptStream(MemoryStream Input, out MemoryStream Output, ref Dictionary<string, string> Headers)
        {
